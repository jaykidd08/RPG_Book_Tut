...
public class Item
{
    ...
    public enum ItemFamilyType { FOOD = 0, LOOT = 1, WEAPON = 2 }
    ...
    { 
        string info = "name:" + this.name + ", health benefits:" + this.healthBenefits + ", dammage" + this.damage + ", nb:" + this.nb + ", max Nb" + this.maxNb + ", type" + this.type; 
        return info; 
    }
}
